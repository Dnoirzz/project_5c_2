...
class _AdminPengumumanPageState extends State<AdminPengumumanPage> {
  ...
  void _editPengumuman(int id) async {
    ...
    final result = await Navigator.push(
      ...
      MaterialPageRoute(
        builder:
            (_) => EditPengumumanPage(
              pengumuman: {
                'id': pengumuman.id,
                'judul': pengumuman.judul,
                'deskripsi': pengumuman.isi,
                'gambar':
                    pengumuman.gambar.isNotEmpty ? pengumuman.gambar : null,
              },
            ),
      ),
    );
  ...
  void _viewDetail(Pengumuman data) async {
    final updated = await Navigator.push(
      context,
      MaterialPageRoute(builder: (_) => DetailPengumumanPage(pengumuman: data)),
    );
